...
<body>
	...
	<div class="container-contact100">
		...
		<?php require_once 'process-review.php';?>
			<form class="contact100-form validate-form" action="process-review.php" method="POST">
				...
				<div class="wrap-input100 input100-select bg1">
					...
					<div>
						<select class="js-select2" name="noodle_id">
				  ...
				  while($row = mysqli_fetch_array($result))
				  {
					  ?>
							...
							<option value="<?php echo $row['noodle_id']?>"><?php echo $row['noodle_name']?></option>
						<?php
				  }
				  ?>
						</select>
				...
				<div class="w-full dis-none js-show-service">
					<div class="wrap-contact100-form-radio">
						<span class="label-input100">Please rate for the noodle you've chosen</span>
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
					...
					<input class="input100" type="text" name="review_title" placeholder="Review Title">
				</div>
				...
				<div class="container-contact100-form-btn">
					<button type="submit" name="submit" class="contact100-form-btn" style="padding-top:0.5cm;">
						<span>
							Submit
