                    ...
                    <div class="col-md-4 col-sm-4">
                      <article class="mu-blog-single-item">
						...
						<?php
						  ...
						  ?>
                          <a href="reviewsingle.php?id=<?php echo $row['review_id']?>"><img src="<?php echo $row2['noodle_image']?>" alt="img" width="368" height = "200"></a>
                        ...
                        <div class="mu-blog-description">
                          ...
                          <a class="mu-read-more-btn" href="review-single.php?id=<?php echo $row['review_id']?>">Read More</a>
                        </div>
                      </article> 
                    </div>
					<?php
